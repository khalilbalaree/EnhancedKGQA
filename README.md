...
(2) In all_kg_new.py file, the default subfolder for load pre-trained kg models are "./ComplEx_MetaQA_full/" and "./data/MetaQA/kb.txt"

(3) In all_kg_new.py file, the default subfolder for load pre-trained Complex is "./ComplEx_MetaQA_full/"
```bash
